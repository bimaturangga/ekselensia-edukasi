...
const SuccessRateMockup = () => (
    <div className="bg-[#2A2A2A] rounded-xl border border-white/5 w-full max-w-[240px] p-5 flex flex-col items-center shadow-xl">
        ...
        <div className="text-white font-bold text-lg mb-1">CGS & CIS</div>
        <div className="bg-[#1F1F1F] text-gray-400 text-[11px] px-3 py-1.5 rounded-md border border-white/5 uppercase tracking-wider font-semibold">Tembus Beasiswa</div>
    </div>
);
...
const DocumentMockupS1S2 = () => (
    <div className="bg-[#2A2A2A] rounded-xl border border-white/5 w-full max-w-[240px] p-4 flex flex-col gap-3 shadow-xl">
        <div className="flex items-center gap-3 bg-[#1F1F1F] p-2.5 rounded-lg border border-white/5">
            ...
            <div className="flex-1 text-xs text-white">Target Kampus</div>
        ...
        <div className="flex items-center gap-3 bg-[#1F1F1F] p-2.5 rounded-lg border border-white/5">
            ...
            <div className="flex-1 text-xs text-white">Proposal Riset</div>
            <div className="text-[10px] text-green-400 bg-green-500/10 px-2 py-0.5 rounded border border-green-500/20">Verified</div>
        </div>
        <div className="flex items-center gap-3 bg-[#1F1F1F] p-2.5 rounded-lg border border-[#7c1318]/40 shadow-[0_0_10px_rgba(124,19,24,0.1)]">
            ...
            <div className="flex-1 text-xs text-white font-medium">Interview</div>
...
const SupportMockup = () => (
    <div className="bg-[#2A2A2A] rounded-xl border border-white/5 w-full max-w-[240px] p-4 flex justify-between shadow-xl relative overflow-hidden">
        ...
        <div className="flex flex-col items-center gap-2 z-10 w-full relative">
            ...
            <div className="text-gray-400 text-[11px] mb-2">Pakar Beasiswa</div>
...
export function BimbinganBeasiswa() {
    return (
            ...
            <section className="relative w-full mb-16 sm:mb-32 pt-24 sm:pt-32 pb-8 sm:pb-12 overflow-hidden border-b border-gray-100/50">
                ...
                <div className="relative px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto z-10">
                    ...
                    <div className="text-center mb-16 relative z-10">
                        ...
                        >
                            <BlurRevealText
                                text="Bimbingan Spesialis Beasiswa Tiongkok"
                                as="h1"
                        ...
                        <p className="text-[15px] sm:text-lg text-gray-600 leading-relaxed max-w-lg mx-auto mb-8 sm:mb-10">
                            Strategi jitu mengamankan beasiswa penuh CGS (Chinese Government Scholarship) atau CIS (Confucius Institute Scholarship) bersama para pakar.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                            <RedButton as="a" href="https://wa.me/6281234567890" target="_blank" rel="noopener noreferrer" className="!px-5 sm:!px-6 !py-2.5 sm:!py-3 !text-[13px] sm:!text-[15px] !rounded-full">
                                Konsultasi Beasiswa <ArrowRight size={16} className="ml-1 sm:ml-2" />
                            </RedButton>
                        </div>
                    </div>
                    ...
                    <div className="w-full h-[400px] md:h-[500px] bg-gray-100 rounded-[20px] overflow-hidden border border-gray-200 shadow-2xl relative z-10 text-left">
                        <ImageWithFallback
                            ...
                            alt="Group of diverse students studying together"
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex items-end p-8 sm:p-10">
                            <div>
                                ...
                                >
                                    Perbesar Peluang Tembus Beasiswa
                                </h3>
                                <p className="text-white/80 text-sm md:text-base max-w-lg leading-relaxed">
                                    Kuasai rahasia lolos seleksi beasiswa prestisius dari pemerintah Tiongkok melalui program bimbingan intensif kami.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <section id="keunggulan" className="bg-[#121212] py-16 sm:py-24 mx-3 sm:mx-5 rounded-[16px] sm:rounded-[20px] mb-16 sm:mb-24 relative overflow-hidden text-white border border-white/5 shadow-2xl">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-10 sm:mb-16">
                        <BlurRevealText
                            text="Keunggulan Bimbingan Beasiswa"
                            as="h2"
                        ...
                        />
                        <p className="text-gray-400">Kenapa program beasiswa kami adalah jalur tercepat menuju kampus impian Anda.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <ScrollReveal>
                            <div className="bg-[#1C1C1C] border border-white/5 rounded-[20px] p-8 flex flex-col items-center text-center transition-all duration-300 hover:bg-[#202020] hover:border-white/10 group h-full">
                                ...
                                <h3 className="text-lg font-bold text-white mb-3">Target CGS & CIS</h3>
                                <p className="text-sm text-gray-400 leading-relaxed">Fokus utama membantu Anda meraih beasiswa bergengsi dengan pendanaan purna.</p>
                            </div>
                        </ScrollReveal>
                        <ScrollReveal>
                            <div className="bg-[#1C1C1C] border border-white/5 rounded-[20px] p-8 flex flex-col items-center text-center transition-all duration-300 hover:bg-[#202020] hover:border-white/10 delay-100 group h-full">
                                ...
                                <h3 className="text-lg font-bold text-white mb-3">Tepat Sasaran</h3>
                                <p className="text-sm text-gray-400 leading-relaxed">Menganalisis kuota mahasiswa asing untuk memetakan kampus dengan probabilitas tertinggi.</p>
                            </div>
                        </ScrollReveal>
                        <ScrollReveal>
                            <div className="bg-[#1C1C1C] border border-white/5 rounded-[20px] p-8 flex flex-col items-center text-center transition-all duration-300 hover:bg-[#202020] hover:border-white/10 delay-200 group h-full">
                                ...
                                <h3 className="text-lg font-bold text-white mb-3">Dokumen Presisi</h3>
                                <p className="text-sm text-gray-400 leading-relaxed">Menyempurnakan Motivation Letter dan Proposal Riset yang diminati oleh komite beasiswa.</p>
                            </div>
                        </ScrollReveal>
                        <ScrollReveal>
                            <div className="bg-[#1C1C1C] border border-white/5 rounded-[20px] p-8 flex flex-col items-center text-center transition-all duration-300 hover:bg-[#202020] hover:border-white/10 delay-300 group h-full">
                                ...
                                <h3 className="text-lg font-bold text-white mb-3">Mentor Berprestasi</h3>
                                <p className="text-sm text-gray-400 leading-relaxed">Dibimbing langsung oleh para pakar dan awardee yang pernah memenangkan beasiswa serupa.</p>
                            </div>
                        </ScrollReveal>
                    </div>
                </div>
            ...
            <section className="max-w-4xl mx-auto px-4 sm:px-6 mb-16 sm:mb-24">
                <div className="text-center mb-10 sm:mb-16 flex flex-col items-center">
                    ...
                    <p className="text-gray-600 max-w-2xl mx-auto">
                        Jalan terstruktur untuk memperbesar rasio kelulusan pendanaan Anda.
                    </p>
                </div>
                ...
                <div className="space-y-8 relative before:absolute before:inset-0 before:ml-[28px] before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-gray-200 before:to-transparent">
                        ...
                        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-16 items-center">
                            ...
                            <div className="pl-[5rem] md:pl-0 md:pr-4 col-start-1 md:col-start-1 text-left md:text-right">
                                <div className="p-6 rounded-2xl bg-white border border-gray-100 shadow-sm transition-transform duration-300 hover:-translate-y-1 inline-block text-left w-full relative z-20">
                                    <h3 className="font-bold text-xl mb-2 text-gray-800">Profiling & Pencocokan</h3>
                                    <p className="text-gray-500 text-sm">Menilai IPK dan kualifikasi HSK, lalu menentukan beasiswa (CGS tipe A/B atau CIS) yang paling potensial untuk dimenangkan.</p>
                                </div>
                            </div>
                        </div>
                    </ScrollReveal>
                        ...
                        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-16 items-center">
                            ...
                            <div className="pl-[5rem] md:pl-4 col-start-1 md:col-start-2">
                                <div className="p-6 rounded-2xl bg-white border border-gray-100 shadow-sm transition-transform duration-300 hover:-translate-y-1 relative z-20">
                                    <h3 className="font-bold text-xl mb-2 text-gray-800">Review Ekstra Dokumen</h3>
                                    <p className="text-gray-500 text-sm">Pembuatan study plan, personal statement, hingga pengurusan Surat Rekomendasi professor atau universitas.</p>
                                </div>
                            </div>
                        </div>
                    </ScrollReveal>
                    ...
                    <ScrollReveal>
                        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-16 items-center">
                            ...
                            <div className="pl-[5rem] md:pl-0 md:pr-4 col-start-1 md:col-start-1 text-left md:text-right">
                                <div className="p-6 rounded-2xl bg-white border border-gray-100 shadow-sm transition-transform duration-300 hover:-translate-y-1 inline-block text-left w-full relative z-20">
                                    <h3 className="font-bold text-xl mb-2 text-gray-800">Simulasi Wawancara</h3>
                                    <p className="text-gray-500 text-sm">Latihan wawancara intensif (mock interview) dengan ekspert bahasa Mandarin dan alumni penerima beasiswa.</p>
                                </div>
                            </div>
                        </div>
                    </ScrollReveal>
                        ...
                        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-16 items-center">
                            ...
                            <div className="pl-[5rem] md:pl-4 col-start-1 md:col-start-2">
                                <div className="p-6 rounded-2xl bg-red-50 border border-red-100 shadow-sm transition-transform duration-300 hover:-translate-y-1 relative z-20">
                                    <h3 className="font-bold text-xl mb-2 text-[#7c1318]">Pengumuman & Pre-Departure</h3>
                                    <p className="text-gray-700 text-sm">Menunggu surat keterangan (Awards Letter) dan panduan administrasi asrama bebas biaya sebelum berangkat.</p>
                                </div>
                            </div>
                        </div>
                    </ScrollReveal>
